...
INSERT INTO TBL_MEMBER 
    ...
    VALUES ('admin1','$2a$10$KQaI.rOOLo2vjNeGoWW03.gi/mHvtrGwHYHbb/BTKZHgCKeHdd0Zy','관리자1','admin1@test.com',SYSDATE);
    
INSERT INTO TBL_MEMBER_AUTH VALUES ('admin1','ROLE_ADMIN','ACTIVE');
    
INSERT INTO TBL_MEMBER 
    (MEMBERID,MEMBERPWD,MEMBERNAME,EMAIL,REGDATE)
    VALUES ('admin2','$2a$10$KQaI.rOOLo2vjNeGoWW03.gi/mHvtrGwHYHbb/BTKZHgCKeHdd0Zy','관리자2','admin2@test.com',SYSDATE);
    
INSERT INTO TBL_MEMBER_AUTH VALUES ('admin2','ROLE_ADMIN','ACTIVE');

INSERT INTO TBL_MEMBER 
    (MEMBERID,MEMBERPWD,MEMBERNAME,EMAIL,REGDATE)
    VALUES ('member1','$2a$10$KQaI.rOOLo2vjNeGoWW03.gi/mHvtrGwHYHbb/BTKZHgCKeHdd0Zy','사용자1','member1@test.com',SYSDATE);

INSERT INTO TBL_MEMBER_AUTH VALUES ('member1','ROLE_MEMBER','ACTIVE');

INSERT INTO TBL_MEMBER 
    (MEMBERID,MEMBERPWD,MEMBERNAME,EMAIL,REGDATE)
    VALUES ('member2','$2a$10$KQaI.rOOLo2vjNeGoWW03.gi/mHvtrGwHYHbb/BTKZHgCKeHdd0Zy','사용자2','member2@test.com',SYSDATE);
